...
CREATE TABLE IF NOT EXISTS `afrontar` (
  ...
  KEY `afrontar_ibfk_2` (`id_amenaza`),
  CONSTRAINT `afrontar_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`),
  CONSTRAINT `afrontar_ibfk_2` FOREIGN KEY (`id_amenaza`) REFERENCES `amenaza` (`id_amenaza`)
...
CREATE TABLE IF NOT EXISTS `corregir` (
  ...
  KEY `id_usuario` (`id_usuario`),
  KEY `corregir_ibfk_2` (`id_debilidad`),
  CONSTRAINT `corregir_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`),
  CONSTRAINT `corregir_ibfk_2` FOREIGN KEY (`id_debilidad`) REFERENCES `debilidad` (`id_debilidad`)
...
CREATE TABLE IF NOT EXISTS `explotar` (
  ...
  KEY `id_usuario` (`id_usuario`),
  KEY `explotar_ibfk_2` (`id_oportunidad`),
  CONSTRAINT `explotar_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`),
  CONSTRAINT `explotar_ibfk_2` FOREIGN KEY (`id_oportunidad`) REFERENCES `oportunidad` (`id_oportunidad`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE IF NOT EXISTS `mantener` (
  ...
  KEY `id_usuario` (`id_usuario`),
  KEY `mantener_ibfk_2` (`id_fortaleza`),
  CONSTRAINT `mantener_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`),
  CONSTRAINT `mantener_ibfk_2` FOREIGN KEY (`id_fortaleza`) REFERENCES `fortaleza` (`id_fortaleza`)
